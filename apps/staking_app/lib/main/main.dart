...
import 'package:staking_app/main/navigation/staking_app_router.dart';

import '../constants/movie_app_constants.dart';
...
class MovieApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp.router(
      routerConfig: StakingAppRouter(MovieAppConstants.navigatorKey).config(),
